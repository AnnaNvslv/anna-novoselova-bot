...
function renderTypes(){document.getElementById('type-list').innerHTML=TYPES_DATA.map(t=>{const loc=t[_lang]||t.ru;return '<div class="type-card" onclick="selectType(\''+t.id+'\')" ><div class="type-icon">'+t.icon+'</div><div style="flex:1"><div class="type-name">'+loc.name+'</div><div class="type-sub">'+loc.sub+'</div><div class="type-meta"><span class="type-dur">⏱ '+loc.dur+'</span><span class="type-price">'+loc.price+'</span></div></div></div>';}).join('');}
