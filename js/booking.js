...
// slotType: 'primary' = основные приёмы 60–120 мин; 'short' = 15-минутные визиты; 'express' = акционная бесплатная диагностика
const TYPES_DATA=[
  {id:'express',icon:'🎁',health:false,slotType:'express',badge:'Акция',ru:{name:'Экспресс-диагностика зрения',sub:'Бесплатно · По акции · Ограниченное число мест',dur:'15 минут',price:'Бесплатно',apptName:'Экспресс-диагностика (акция)'},sr:{name:'Ekspres dijagnostika vida',sub:'Besplatno · Akcija · Ograničen broj mesta',dur:'15 minuta',price:'Besplatno',apptName:'Ekspres dijagnostika (akcija)'},consult:0},
